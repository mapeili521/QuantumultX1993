...
if (typeof $response === "undefined") {
  ...
  if (url.includes("/api.caiyunapp.com/v1/activity")) {
    ...
    if (obj?.vip_info?.svip) {
      ...
      obj.vip_info.svip.expires_time = "2556057600"; // 到期时间修改为 2050年12月30日
    }
    ...
    // 我的页面
    if (obj.vip) {
      obj.vip.expires_time = "2556057600"; // 到期时间修改为 2050年12月30日
    }
    if (obj.svip) {
      obj.svip.expires_time = "2556057600"; // 到期时间修改为 2050年12月30日
    }
    ...
    if (obj?.result) {
      ...
      obj.result.vip_expired_at = 2556057600.16; // 到期时间修改为 2050年12月30日
      obj.result.is_vip = true;
      obj.result.xy_svip_expire = 2556057600.16; // 到期时间修改为 2050年12月30日
      if (obj?.result?.wt) {
        if (obj.result.wt.vip) {
          obj.result.wt.vip.enabled = true;
          obj.result.wt.vip.expired_at = 2556057600.16; // 到期时间修改为 2050年12月30日
          obj.result.wt.vip.svip_expired_at = 2556057600.16; // 到期时间修改为 2050年12月30日
        }
        obj.result.wt.svip_given = 730;
      }
      obj.result.is_primary = true;
      obj.result.xy_vip_expire = 2556057600.16; // 到期时间修改为 2050年12月30日
      obj.result.svip_expired_at = 2556057600.16; // 到期时间修改为 2050年12月30日
